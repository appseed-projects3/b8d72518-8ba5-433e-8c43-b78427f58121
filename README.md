...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-08-18 10:18`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b8d72518-8ba5-433e-8c43-b78427f58121.git
$ cd b8d72518-8ba5-433e-8c43-b78427f58121
```
